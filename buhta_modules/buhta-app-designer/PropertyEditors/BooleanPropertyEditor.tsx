    ...
    render(): JSX.Element {
        ...
        return (
            <Input
                ...
                checkboxCaption={this.props.inputCaption}
                {...this.getRenderProps()}
            />
        );
    }
...
export interface BooleanEditorParams extends AutoFormControlProps {

}

export function BooleanEditor(params: BooleanEditorParams = {}): Function {
    return function (target: any, propertyName: string) {
        ...
        let propertyEditorInfo: PropertyEditorInfo = {
            ...
            editorType: BooleanPropertyEditor,
