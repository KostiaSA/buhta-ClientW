...
//     if (!obj || processed[(obj as any).$$uniqueObjectId] === true)
//         return;
//
//     if ((obj as any).$$uniqueObjectId !== undefined)
//         (obj as any).$$uniqueObjectId = Math.random().toString(36).slice(2, 16);
//     processed[(obj as any).$$uniqueObjectId] = true;
//
